...
- [ ] Надо сделать колл-беки для:
  - Чтения данных из сервера или базы данных
  - Записи данных яйчейки
  - Добавление или удаление строк и столбцов
- [ ] Если не настроены колл-беки, сдлаьб дефолтные, которые просто образаются к БД Vuex + localstorage
